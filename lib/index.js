...
**/
Wall$1.prototype.randomStart = function randomStart (rnd) {
...
function carve() {
  ...
  var rnd = function (x) { return (random() * x)|0; };
  var mov = Move.fromDir(Up$2);
  var ref = this.randomStart(rnd);
  var x = ref[0];
  var y = ref[1];
    ...
    check: while (outbound_or_marked(x, y, mov)) {
      ...
      do {
        ...
        if (!this$1.inBounds(x, y)) {
          var assign;
          (assign = this$1.randomStart(rnd), x = assign[0], y = assign[1]);
        }
...
var Up$3 = Direction.Up;
var Left$3 = Direction.Left;
/**
...
function draw(writer) {
  ...
  for(var y$1 = 0, len = this.rows; y$1 < len; ++y$1) {
    for(var x$1 = 0, len$1 = this.cols; x$1 < len$1; ++x$1) {
      if (x$1 == 0 || this$1.isOpen(x$1 - 1, y$1, Up$3)) {
        if (y$1 == 0 || this$1.isOpen(x$1, y$1 - 1, Left$3)) {
          if (this$1.isOpen(x$1, y$1, Up$3)) {
            writer(this$1.isOpen(x$1, y$1, Left$3) ? "  " : "╻ ");
          } else {
            writer(this$1.isOpen(x$1, y$1, Left$3) ? "╺━" : "┏━");
          }
        } else {
    ...
    var x$2 = this$1.cols;
    if (this$1.isOpen(x$2 - 1, y$1, Up$3)) {
      if (y$1 == 0 || this$1.isOpen(x$2, y$1 - 1, Left$3)) {
        writer(this$1.isOpen(x$2, y$1, Left$3) ? " " : "╻");
      } else {
        writer(this$1.isOpen(x$2, y$1, Left$3) ? "╹" : "┃");
      }
    } else {
  ...
  for(var x$3 = 0, len$2 = this.cols; x$3 < len$2; ++x$3) {
    if (x$3 == 0 || this$1.isOpen(x$3 - 1, y, Up$3)) {
      if (this$1.isOpen(x$3, y - 1, Left$3)) {
        writer(this$1.isOpen(x$3, y, Up$3) ? "  " : "╺━");
      } else {
        writer(this$1.isOpen(x$3, y, Up$3) ? "╹ " : "┗━");
      }
    } else {
      if (y == 0 || this$1.isOpen(x$3, y - 1, Left$3)) {
        writer(this$1.isOpen(x$3, y, Up$3) ? "╸ " : "━━");
      } else {
        writer(this$1.isOpen(x$3, y, Up$3) ? "┛ " : "┻━");
      }
  ...
  var x = this.cols;
  if (this.isOpen(x - 1, y, Up$3)) {
    writer(this.isOpen(x, y - 1, Left$3) ? " " : "╹");
  } else {
    writer(this.isOpen(x, y - 1, Left$3) ? "╸" : "┛");
  }
  writer("\n");
